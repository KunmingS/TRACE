...
} from '../../../logic/import/csv/CSVErrors';
...
const ImportLabelPopup: React.FC<IProps> = (
    ...
    const resolveNotification = (error: Error): Notification => {
        if (error instanceof CSVAnnotationFileCountError ||
            error instanceof CSVAnnotationReadingError ||
            error instanceof CSVAnnotationDeserializationError ||
            error instanceof CSVFormatValidationError) {
        ...
        if (annotationsLoadedError) {
            ...
            return <>
                ...
                <img
                    ...
                    src={'ico/box-opened.png'}
                />
                <p className='extraBold'>Drop CSV annotations</p>
                <p>or</p>
    ...
    const renderInternalContent = (type: LabelType) => {
        ...
        return importFormatData.length === 0 ?
            <div className='Message'>No import formats available for this label type.</div> :
