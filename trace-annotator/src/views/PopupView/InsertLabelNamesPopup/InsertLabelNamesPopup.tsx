...
const InsertLabelNamesPopup: React.FC<IProps> = (
    ...
    const onChangeShortcut = (id: string, value: string) => {
        // Only allow single lowercase letter
    ...
    const labelInputs = labelNames.map((labelName: LabelName) => {
        ...
        const onChangeShortcutCallback = (event: React.ChangeEvent<HTMLInputElement>) =>
            onChangeShortcut(labelName.id, event.target.value);
        ...
        return <div className='LabelEntry' key={labelName.id}>
            ...
            <StyledTextField variant='standard'
                ...
                onChange={onChangeShortcutCallback}
