...
RESOLVED_CONFIG_NAME = "config_resolved.py"
...
def resolve_model_dir(model_dir):
    ...
    if resolved.is_file():
        # What the run actually trained with. Preferred over config.txt, which
        # stores a path: editing that source file later would silently change how
        # this finished model is rebuilt.
